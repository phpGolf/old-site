            ...
            <tr>
                ...
                foreach ($result as $key => $line) {
                    if ($line != $valid[$key]) {
                        ...
                        echo '<span class="user" style="color: red; vertical-align: top">'.htmlspecialchars($line).'</span><span class="user" name="newline" style="color: blue; display: none;">LF</span>'."\n";
                    } else {
                        $line = str_replace("\r",'',$line);
                        echo '<span class="user">'.htmlspecialchars($line).'</span><span class="user" name="newline" style="color: blue; display: none;">LF</span>'."\n";
                    }
                ...
                foreach ($valid as $key => $line) {
                    echo '<span class="valid">'.htmlspecialchars($line).'</span><span class="valid" name="newline" style="color: blue; display: none;">LF</span>'."\n";
                }
                ?></pre></td>
            </tr>
            <tr>
                <td style="text-align:left;font-weight:bold;">User controls</td>
                <td style="text-align:left;font-weight:bold;">Valid controls</td>
            </tr>
            <tr>
                <td style="text-align:left;">Show spaces <input type="checkbox" class="user" name="space"></td>
                <td style="text-align:left;">Show spaces <input type="checkbox" class="valid" name="space"></td>
            </tr>
            <tr>
                <td style="text-align:left;">Show newlines <input type="checkbox" class="user" name="newlines"></td>
                <td style="text-align:left;">Show newlines <input type="checkbox" class="valid" name="newlines"></td>
            </tr>
        </table>
        <?php
        } else {
