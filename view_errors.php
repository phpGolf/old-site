...
if (is_numeric($_GET['value'][1])) {
    $stmt = $PDO->prepare('SELECT a.errors, a.user_id, a.size, c.name, c.enddate
...
<html>
    <head>
        <title>Errors for <?=$row['name']; ?></title>
    </head>
    <body style="background-color:#123456;font-size:12px;">
        <div style="background-color:#E8E8E8; margin:5px;padding: 4px;">
        <?php
